 ...
 * @param detectionIntervalMs minimum delay between two detection counter checks, in milliseconds.
 * @param requiredDetectionCount number of positive detections required before this condition is fulfilled.
 * @param resetAfterTrigger true to reset the detection counter after the condition is fulfilled.
 */
...
const val DEFAULT_REQUIRED_DETECTION_COUNT = 1
const val DEFAULT_RESET_AFTER_TRIGGER = true
